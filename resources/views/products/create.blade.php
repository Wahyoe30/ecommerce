                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="description" placeholder="Masukan Deskripsi Produk">{{ old('desc') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="stock" placeholder="Masukan Stok Produk">{{ old('stock') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
